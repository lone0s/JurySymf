 ...
 *     }
 * )
 * @Entity(repositoryClass="App\Repository\EtudiantRepository")
 */
class Etudiant
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=InscriptionPeriode::class, mappedBy="etudiant")
     */
    private $inscriptionsPeriodes;

    /**
     * @ORM\OneToMany(targetEntity=InscriptionUe::class, mappedBy="etudiant")
     */
   ...
   public function __construct()
    ...
    public function addInscriptionPeriode(InscriptionPeriode $inscriptionPeriode): self
    {
